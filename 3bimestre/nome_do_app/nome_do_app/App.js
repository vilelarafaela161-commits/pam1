...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#0D0E12', // Fundo escuro moderno
  },
  ...
  mainTitle: {
    fontSize: 36,
    fontWeight: '900',
    color: '#F5C518', // Dourado elegante para o título principal
    letterSpacing: 2,
  ...
  lyricsGrid: {
    ...
    flexWrap: 'wrap',     // Passa para a linha de baixo se faltar espaço
    justifyContent: 'center',
    gap: 16,               // Espaçamento uniforme entre os cards
    width: '100%',
    marginBottom: 30,
  },

  verseCard: {
    backgroundColor: '#17181F', // Card de estrofe
    borderRadius: 12,
    padding: 18,
    minWidth: 260,
    maxWidth: 320,
